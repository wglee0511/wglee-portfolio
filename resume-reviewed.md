...
기획·설계·구현·배포까지 혼자 끝내는 사이클을 반복하며, 2026년 상반기에만 세 개의 제품을 PRD 작성부터 배포까지 단독으로 완주했습니다. 복약 기록 앱(**Cadence**)의 오프라인 퍼스트 구조, 위치 리마인더 앱(**스팟 스테이플러**)의 앱 종료 상태 지오펜싱, 주유소 추천 웹(**찍고가**)의 경로↔주유소 매칭 알고리즘을 각각 직접 설계하고 구현했습니다.
