  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col items-center justify-center pt-20 overflow-hidden">
      ...
      >
        ...
        <h1 className="fluid-h1 font-bold mb-8" style={{ color: 'var(--text-primary)' }}>
        ...
        >
          ...
          <motion.a
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 rounded-full font-bold transition-all text-sm sm:text-base"
