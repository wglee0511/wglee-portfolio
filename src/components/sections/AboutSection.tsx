...
const investmentPoints = [
  {
    title: "성능 최적화",
    desc: "성능 저하의 구조적 원인을 찾아 코드 수준에서 해결합니다. 체감이 아닌 계측 데이터로 개선 전후를 직접 측정하고 검증합니다.",
    badge: "Strong Buy",
    up: true,
  },
  {
  ...
  {
    title: "AI 개발 환경 구축",
    desc: "코드 리뷰·타입 검증·빌드 진단을 자동화하는 AI 개발 하네스를 설계해 팀 전체에 배포했고, 이후 팀원들이 규칙을 추가하며 공동 운영했습니다.",
    badge: "Strong Buy",
    up: true,
  },
  {
    title: "제품 전 과정 경험",
    desc: "기획부터 배포까지 제품의 전 과정을 경험합니다. 2026년 상반기에만 복약 기록 앱·위치 리마인더 앱·주유소 추천 웹을 PRD 작성부터 배포까지 완주했습니다.",
    badge: "Strong Buy",
    up: true,
  },
  {
