  ...
  const experiences: Experience[] = [
    {
      ...
      tasks: [
        ...
        },
        {
          title: "상태 관리 구조 개선",
          items: [
            "서버 상태를 스토어로 복사하던 구조를 걷어내 React Query가 서버 상태를 소유하도록 정리",
            "화면마다 흩어져 있던 구독 상태 판단 로직을 전용 selector 로 중앙화 (60개 호출 지점) — 동일 조건이 화면별로 달라지던 문제 제거",
            "스토어 21개 규모에서 파생 상태를 computed 로 전환 — 정렬·전개 목록을 별도 저장하던 구조를 제거해 목록 갱신 시 set 호출 3회를 1회로 축소, 스토어별 version·migrate로 저장 구조 변경 대응",
